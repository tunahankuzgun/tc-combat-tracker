  ...
  return (
    <div className="min-h-screen bg-slate-900 p-4">
      <header className="text-center mb-8">
        <h1 className="text-3xl font-bold text-red-600 mb-2">TRENCH CRUSADE</h1>
        <h2 className="text-xl text-slate-300 mb-4">Combat Tracker</h2>
          ...
          {currentBattle ? (
            <div className="mb-4 p-4 bg-slate-800 rounded border border-green-600">
              ...
              <div className="flex gap-2">
                <Link
                  href="/battle"
                  className="grimdark-button px-4 py-2 bg-green-700 hover:bg-green-600"
                >
                  Continue Battle
                </Link>
