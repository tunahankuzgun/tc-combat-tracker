    ...
    <div className="min-h-screen bg-slate-900 p-4">
      ...
      <main className="max-w-4xl mx-auto">
        ...
        <div className="flex gap-4 justify-center">
          <Link href="/" className="grimdark-button px-6 py-3">
            Cancel
          </Link>
          <button
      ...
      {/* Add Unit Modal */}
      {showAddUnit && (
        <AddUnitModal onAdd={addUnit} onCancel={() => setShowAddUnit(false)} />
      )}
    </div>
  );
}
...
function AddUnitModal({ onAdd, onCancel }: AddUnitModalProps) {
  ...
  const updateField = (
    ...
    value: string | number | FactionType
  ) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                updateField("faction", e.target.value as FactionType)
              }
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  updateField(
                    "maxWounds",
                    Math.max(wounds, formData.maxWounds)
                  );
                }}
                className="w-full px-3 py-2 bg-slate-800 border border-slate-600 rounded text-slate-100 focus:border-red-500 focus:outline-none"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateField("agility", parseInt(e.target.value))
                }
                className="w-full px-3 py-2 bg-slate-800 border border-slate-600 rounded text-slate-100 focus:border-red-500 focus:outline-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateField("movement", parseInt(e.target.value))
                }
                className="w-full px-3 py-2 bg-slate-800 border border-slate-600 rounded text-slate-100 focus:border-red-500 focus:outline-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateField("rangedAttack", parseInt(e.target.value))
                }
                className="w-full px-3 py-2 bg-slate-800 border border-slate-600 rounded text-slate-100 focus:border-red-500 focus:outline-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateField("meleeAttack", parseInt(e.target.value))
                }
                className="w-full px-3 py-2 bg-slate-800 border border-slate-600 rounded text-slate-100 focus:border-red-500 focus:outline-none"
              />
            </div>
