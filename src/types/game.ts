...
export const FACTION_CONFIGS: Record<FactionType, FactionConfig> = {
  [FactionType.TRENCH_PILGRIMS]: {
    ...
    color: '#8B4513', // brown
    description: 'Faithful soldiers of the Church, fighting in the name of righteousness.',
    specialRules: ['Faith Points', 'Divine Protection']
  },
  [FactionType.IRON_SULTANATE]: {
    name: 'Iron Sultanate',
    color: '#DC143C', // crimson
    description: 'Elite warriors of the Sultanate, masters of steel and gunpowder.',
  ...
  [FactionType.COURT_OF_SEVEN_HEADED_SERPENT]: {
    ...
    color: '#4B0082', // indigo
    description: 'Heretical cultists wielding dark magic and forbidden knowledge.',
